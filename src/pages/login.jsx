...
import bgImage from "../assets/manhwa/loyd.png";
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="flex w-full max-w-5xl min-h-[85vh] rounded-2xl overflow-hidden shadow-[0_0_100px_rgba(220,38,38,0.12)] border border-white/5">
        ...
        <div className="hidden md:block relative w-1/2">
          ...
          <div className="absolute right-0 top-0 bottom-0 w-px bg-red-600/50" />
          <div className="absolute bottom-12 left-8 right-8">
            ...
            <p className="text-gray-400 text-sm tracking-widest uppercase">Your Universe Awaits</p>
          </div>
        </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-1">
                <div className="flex justify-between items-center">
                  ...
                  <button type="button" className="text-xs text-red-500 hover:text-red-400 transition-colors">Forgot?</button>
                </div>
                <input
                  type="password"
                  placeholder="••••••••"
              ...
              <p className="text-zinc-500 text-xs text-center">
                ...
                <button onClick={() => navigate("/signup")} className="text-red-500 hover:text-red-400 font-semibold transition-colors">
                  Create an account
                </button>
              </p>
            </div>
